...
public class JsonUtils {
    ...
    public static String toString(JsonElement json) {
        String s = org.apache.commons.lang.StringUtils.abbreviateMiddle(String.valueOf(json), "...", 10);
    ...
    @Nullable
    public static <T> T gsonDeserialize(Gson gson, Reader reader, Type type, boolean lenient) {
        try {
            JsonReader jsonreader = new JsonReader(reader);
            jsonreader.setLenient(lenient);
            //noinspection unchecked
    ...
    @Nullable
    public static <T> T gsonDeserialize(Gson gson, String jsonString, Type type, boolean lenient) {
        //noinspection unchecked
        return (T) gsonDeserialize(gson, new StringReader(jsonString), type, lenient);
    }

    @Nullable
    public static <T> T gsonDeserialize(Gson gson, String jsonString, Class<T> adapter, boolean lenient) {
        return gsonDeserialize(gson, new StringReader(jsonString), adapter, lenient);
    }

    @Nullable
    public static <T> T gsonDeserialize(Gson gson, Reader reader, Type type) {
        //noinspection unchecked
        return (T) gsonDeserialize(gson, reader, type, false);
    }

    @Nullable
    public static <T> T gsonDeserialize(Gson gson, String jsonString, Type type) {
        //noinspection unchecked
        return (T) gsonDeserialize(gson, jsonString, type, false);
    }

    @Nullable
    public static <T> T gsonDeserialize(Gson gson, Reader reader, Class<T> type) {
        return gsonDeserialize(gson, reader, type, false);
    }

    @Nullable
    public static <T> T gsonDeserialize(Gson gson, String jsonString, Class<T> adapter) {
        return gsonDeserialize(gson, jsonString, adapter, false);
    }
}
